...
#define SQL_CREATE_TABLE [NSString stringWithFormat:@"CREATE TABLE IF NOT EXISTS %@ (%@ TEXT, %@ DOUBLE);", TABLE_NAME, COLUMN_NAME_CAMPAIGN_ID, COLUMN_NAME_TIMESTAMP]
#define SQL_INSERT [NSString stringWithFormat:@"INSERT INTO %@ (%@, %@) VALUES (?, ?);", TABLE_NAME, COLUMN_NAME_CAMPAIGN_ID, COLUMN_NAME_TIMESTAMP]
